  ...
  run(
    ...
    [
      ...
      [
        ...
        'const plain = await import("@tracegate/adapters/plain-functions");',
        ...
        'if (typeof plain.createTraceGateFunctionRegistry !== "function") throw new Error("plain-functions import failed");',
      ].join(" "),
    ],
    { cwd: consumerDir },
  );
